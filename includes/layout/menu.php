          ...
          <div class="brand-sidebar">
            <h1 class="logo-wrapper">
              <a href="index-2.html" class="brand-logo darken-1">
                <img src="<?php echo $ruta_base;?>/assets/img/logo/materialize-logo.png" alt="materialize logo">
                ...
                <li class="bold">
                  ...
                  <div class="collapsible-body">
                    <ul>
                      ...
                      <li>
                        <a href="https://pixinvent.com/materialize-material-design-admin-template/html/overlay-menu/">
                          <i class="material-icons">keyboard_arrow_right</i>
